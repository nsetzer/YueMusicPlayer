...
def LoadLibrary(libname):
    ...
    bass_module = ctypes.CDLL(LookPath(libname), mode=ctypes.RTLD_GLOBAL)
    #bass_module = ctypes.CDLL(libname, mode=ctypes.RTLD_GLOBAL)
...
bass_module,func_type = LoadLibrary("bass");
